...
def universal_attack(samples, args, trainer, generator, embedding_weight, itr, bpe):
    ...
    while True: # gradient attack will early stop        
        ...
        batch_size = 64
        all_inference_samples, _ = all_attack_utils.build_inference_samples_difficult(samples, batch_size, args, candidate_input_tokens, trainer, bpe, num_trigger_tokens=num_trigger_tokens)
